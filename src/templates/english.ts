export const getTemplate = (company: string) =>
`
# Building Technology That Matters
The reason I became interested in applying to ${company} is because I believe that technology should solve real problems and make meaningful impacts on people's lives. Throughout my career, I've focused on creating solutions that actually work and serve genuine needs.
